    ...
    local definitions = {
        ...
        wins = {
            -- Highlight current line only on focused window
            {
                ...
                [[if ! &cursorline && &filetype !~# '^\(clap_\)' && ! &pvw | setlocal cursorline | endif]]
            }, {
                "WinLeave,BufLeave,InsertEnter", "*",
                [[if &cursorline && &filetype !~# '^\(clap_\)' && ! &pvw | setlocal nocursorline | endif]]
        ...
        ft = {{"BufNewFile,BufRead", "*.toml", " setf toml"}},
