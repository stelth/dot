...
(defun vc-project-root (dir)
  "Return to the root of project in DIR."
  (require 'vc)
...
(defvar my-project-build-directoris
  '(("None" . "build" )
    ("Debug" . "build.dbg" )
    ("Release" . "build.rel")
  ...
  (let* ((default-directory dir)
    ...
    (ede-add-project-to-global-list
     (ede-ninja-project
      ...
      :configuration-default (or (car active-config-and-dir) (car (car my-build-project-directories)))
...
(defun my-ede-hook ()
  ;; These are a bit more convenient than the default bindings
