...
local def_map = {
    ...
    ["n|<Leader>sl"] = map_cu('SessionLoad'):with_noremap(), -- Insert
    ...
    ["i|<C-e>"] = map_cmd([[pumvisible() ? "\<C-e>" : "\<End>"]]):with_noremap()
        :with_expr(), -- command line
    ...
    ["n|<BS>"] = map_cmd(":noh<CR>"):with_noremap():with_silent()
}
