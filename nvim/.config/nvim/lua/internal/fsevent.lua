...
function fs:quit_fs_window()
    ...
    window.nvim_close_valid_window({
        self.input_cw, self.input_bw, self.hcw, self.hbw
    })
end
...
function fsevent.file_event() fs:render_window() end

function fsevent.do_file_action() fs:do_file_action() end

function fsevent.quit_fs_window() fs:quit_fs_window() end
