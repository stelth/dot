...
local function setup_treesitter_textobjects(bufnr)
    ...
    local selection_operator_keymap = {
        ...
        ["if"] = {
            "<cmd>lua require('nvim-treesitter.textobjects.select').select_textobject('@function.inner', 'o')<CR>",
            "Select inner function"
        },
        ["ac"] = {
            "<cmd>lua require('nvim-treesitter.textobjects.select').select_textobject('@class.outer', 'o')<CR>",
            "Select outer class"
        },
        ["ic"] = {
            "<cmd>lua require('nvim-treesitter.textobjects.select').select_textobject('@class.inner', 'o')<CR>",
            "Select inner class"
        }
    }
    wk.register(selection_operator_keymap,
                {buffer = bufnr, mode = "o", noremap = true, silent = true})

    local selection_operator_keymap_visual = {
        ["af"] = {
            "<cmd>lua require('nvim-treesitter.textobjects.select').select_textobject('@function.outer', 'x')<CR>",
            "Select outer function"
        },
        ["if"] = {
            "<cmd>lua require('nvim-treesitter.textobjects.select').select_textobject('@function.inner', 'x')<CR>",
            "Select inner function"
        },
        ["ac"] = {
            "<cmd>lua require('nvim-treesitter.textobjects.select').select_textobject('@class.outer', 'x')<CR>",
            "Select outer class"
        },
        ["ic"] = {
            "<cmd>lua require('nvim-treesitter.textobjects.select').select_textobject('@class.inner', 'x')<CR>",
            "Select inner class"
        }
    }
    wk.register(selection_operator_keymap_visual,
                {buffer = bufnr, mode = "x", noremap = true, silent = true})
    ...
    local move_operator_keymap = {
        ...
        ["]M"] = {
            "<cmd>lua require('nvim-treesitter.textobjects.move').goto_next_end('@function.outer'<CR>",
            "Goto next function end"
        },
        ["]["] = {
            "<cmd>lua require('nvim-treesitter.textobjects.move').goto_next_end('@class.outer'<CR>",
            "Goto next class end"
        },
        ["[m"] = {
        ...
        ["[]"] = {
            "<cmd>lua require('nvim-treesitter.textobjects.move').goto_previous_end('@class.outer')<CR>",
            "Goto previous class end"
        }
    }
    wk.register(move_operator_keymap,
                {buffer = bufnr, mode = "o", noremap = true, silent = true})
    ...
    wk.register(swap_operator_keymap, {
        prefix = "<leader>",
        buffer = bufnr,
        noremap = true,
        silent = true
        ...
        c = {
            ...
            c = {
                ...
                ic = {
                    ...
                    "Increase Comment Level (Line)"
                },
                i = {
                    "<Plug>kommentary_motion_increase",
                    "Increase Comment Level (Motion)"
                },
                dc = {
                    "<Plug>kommentary_line_decrease",
                    "Decrease Comment Level (Line)"
                },
                d = {
                    "<Plug>kommentary_motion_default",
                    "Decrease Comment Level (Motion)"
                }
            }
        }
    }
    wk.register(kommentary_normal_keymap, {
        prefix = "<leader>",
        buffer = bufnr,
        noremap = true,
        silent = true
        ...
        c = {
            ...
            c = {
                ...
                i = {
                    ...
                    "Increase (Visual Selection)"
                },
                d = {
                    "<Plug>kommentary_visual_decrease",
                    "Decrease (Visual Selection)"
                }
            }
        }
    }
    wk.register(kommentary_visual_keymap, {
        prefix = "<leader>",
        buffer = bufnr,
        noremap = true,
        silent = true,
