...
in
{
  "prettierd" = nodeEnv.buildNodePackage {
    ...
    version = "0.14.3";
    src = fetchurl {
      url = "https://registry.npmjs.org/@fsouza/prettierd/-/prettierd-0.14.3.tgz";
      sha512 = "wptGHIEP7DYGsraCEMi+oqyvrdksYW2ch2OfRS9i6egTFwiTPKPw6i2k/8MW8q0T8fUgeXTopqssSLm7oUOtxQ==";
    };
    dependencies = [
