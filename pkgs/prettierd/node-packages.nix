  ...
  sources = {
    "core_d-3.2.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "waKkgHU2P19huhuMjCqCDWTYjxCIHoB+nnYjI7pVMUOC1giWxMNDrXkPw9QjWY+PWCFm49bD3wA/J+c7BGZ+og==";
      };
    };
    "has-flag-4.0.0" = {
      name = "has-flag";
...
in {
  "@fsouza/prettierd" = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      url =
        "https://registry.npmjs.org/@fsouza/prettierd/-/prettierd-0.18.1.tgz";
      sha512 =
        "W2H1E09e1B31MuyOlpXOtemxZ+9qZk7TTOzebVDh5WqHB7+jo1WOJtGwwTyp1k9irlvqqF/FpRzIUrKBR4KGqA==";
    };
    dependencies = [
